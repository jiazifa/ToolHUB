...
def get_header(modifier: Optional[Dict[str, str]] = None) -> Dict[str, str]:
    HEADER: Dict[str, str] = {}
    HEADER.setdefault(
        "Accept",
        "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"
    )  # noqa
    HEADER.setdefault("Accept-Charset", "UTF-8,*;q=0.5")
    HEADER.setdefault("Accept-Encoding", "gzip,deflate,sdch")
    HEADER.setdefault("Accept-Language", "en-US,en;q=0.8")
    HEADER.setdefault(
        "User-Agent",
